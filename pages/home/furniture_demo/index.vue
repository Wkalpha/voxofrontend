<template>
  <Head>
    ...
    <Link rel="icon" href="/favicons/4.png"></Link>
  </Head>
  <layout1 iconBgColor="theme-bg-color" :formControlColor="'color-4'">
    ...
    <HomeFurnitureDemoComponentsBanner :banners="
    ...
    <HomeFurnitureDemoComponentsHurryUp :tabList="
      hurryUpBannersList.filter((item) => item.subtype === 'hurryup')[0].tabs
    " />
    <HomeFurnitureDemoComponentsInstagramShop :banners="
